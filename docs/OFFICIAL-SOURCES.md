...
기획·실험·출품 시 아래 공식 문서를 정본으로 사용한다. 정책은 바뀔
수 있으므로 앱 유형 결정, 번들 등록, 출시 검토 직전에 다시 확인한다.

- 7월 바이브코딩 챌린지:
  https://toss.im/apps-in-toss/blog/2607_vibecoding_challenge
- 콘솔에서 앱 등록하기·게임 등급분류:
...
- 핵심 지표:
  https://developers-apps-in-toss.toss.im/analytics/conversion-metrics.html
- 게임 출시 가이드:
